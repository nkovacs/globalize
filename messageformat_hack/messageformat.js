 ...
 * @private  */
MessageFormat.prototype._precompile = function(ast, fmtfns, context) {
  function _precompileInternal(ast, data) {
    data = data || { keys: {}, offset: {} };
    var r = [], i, tmp, args = [], fmtfni, params;

    switch ( ast.type ) {
      case 'messageFormatPattern':
        for ( i = 0; i < ast.statements.length; ++i ) {
          r.push(_precompileInternal.call( this, ast.statements[i], data ));
        }
        tmp = r.join(' + ') || '""';
      ...
      case 'messageFormatElement':
        ...
        if ( ast.output ) {
          ...
          return _precompileInternal.call( this, ast.elementFormat, data );
        }
      ...
      case 'elementFormat':
        ...
        switch (ast.key) {
          case 'select':
            args.push(_precompileInternal.call(this, ast.val, data));
            return 'select(' + args.join(', ') + ')';
          case 'selectordinal':
            args = args.concat([ 0, propname(this.lc[0], 'pluralFuncs'), _precompileInternal.call(this, ast.val, data), 1 ]);
            return 'plural(' + args.join(', ') + ')';
          case 'plural':
            data.offset[data.pf_count || 0] = ast.val.offset || 0;
            args = args.concat([ data.offset[data.pf_count] || 0, propname(this.lc[0], 'pluralFuncs'), _precompileInternal.call(this, ast.val, data) ]);
            return 'plural(' + args.join(', ') + ')';
          default:
            ...
            fmtfni = fmtfns.length;
            fmtfns.push(this.runtime.fmt[ast.key].apply(context, params));

            return 'fmtfns[' + fmtfni + '](' + args.join(', ') + ')';
      ...
      case 'selectFormatPattern':
        ...
        for (i = 0; i < ast.pluralForms.length; ++i) {
          ...
          data_copy.pf_count++;
          r.push(propname(key) + ': function() { return ' + _precompileInternal.call(this, ast.pluralForms[i].val, data_copy) + ';}');
        }
  ...
  return _precompileInternal.call(this, ast);
};
 ...
 * i18n.fi.b({ COUNT: 3 })
 * // 'Tämä on 3. esimerkki.'  */
MessageFormat.prototype.compile = function ( messages, opt, context, fmtfns ) {
  var r = {}, lc0 = this.lc,
      compileMsg = function(self, msg) {
        try {
          var ast = MessageFormat._parse(msg);
          return self._precompile(ast, fmtfns, context);
        } catch (e) {
  ...
  if (typeof messages == 'string') {
    var f = new Function(
        'number, plural, select, pluralFuncs, fmt, fmtfns',
        'return ' + compileMsg(this, messages));
    return f(this.runtime.number, this.runtime.plural, this.runtime.select,
        this.runtime.pluralFuncs, this.runtime.fmt, fmtfns);
  }
